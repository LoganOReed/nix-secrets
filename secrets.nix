...
let
  ...
  occam = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIK6sLwHf6YinWCrt0amlNhrWml3i+Vq7Ju1GcnAWd1zL occam@razor";
  users = [ occam ];

  # get system's ssh public key by command:
  #    cat /etc/ssh/ssh_host_ed25519_key.pub
  ai = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIPJucYK/TdGJqfqKhubugyx6L6N5RBXvBETJQ/ytLlmt root@razor";
  systems = [ ai ];
in
{
